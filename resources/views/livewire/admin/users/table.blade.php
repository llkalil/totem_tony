            ...
            <table class="min-w-full leading-normal">
                ...
                @forelse($users as $user)
                    <tr>
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">
                                {{ $user->created_at->toFormattedDateString('d/m/Y H:i:s') }}
                                @if ($user->created_at->diff(now())->days <= 7)
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <button type="button"
                                    onclick="Livewire.emit('openModal', 'admin.users.edit',{{json_encode(['user_id'=>$user->id])}})"
            ...
            @if (!count($users))
                <div class="flex justify-center flex-col gap-2 items-center my-8">
                    ...
                    <h1 class="text-xl  p-3">
                        Nada encontrado, adicione um usuário acima ou
                        <a
                                onclick="Livewire.emit('openModal', 'admin.users.create')"
