                    ...
                    <tr>
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">
                                ...
                                @if ($category->created_at->diff(now())->days <= 7)
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            @if ($category->active)
                                <span class="relative inline-block rounded-full bg-green-100 px-3 py-1 font-semibold text-green-900 leading-tight">
							        <span class="relative">Ativo</span>
							    </span>
                            @else
                                <span class="relative inline-block rounded-full bg-red-100 px-3 py-1 font-semibold text-red-900 leading-tight">
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <button type="button"
                                    onclick="Livewire.emit('openModal', 'admin.categories.edit',{{json_encode(['category_id'=>$category->id])}})"
                ...
                <div class="flex justify-center flex-col gap-2 items-center my-8">
                    <svg width="824" height="242" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            ...
                            <linearGradient id="b" x1="558.006" y1="22.0271" x2="558.065" y2="17.4425"
                                            gradientUnits="userSpaceOnUse">
                                <stop offset=".1653" stop-color="#E3E5EA"/>
                    ...
                    <h1 class="text-xl  p-3">
                        ...
                        <a
                                onclick="Livewire.emit('openModal', 'admin.categories.create')"
