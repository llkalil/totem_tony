            ...
            <table class="min-w-full leading-normal">
                ...
                @forelse($products as $product)
                    <tr>
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">
                                R$ {{ number_format($product->market_price,2) }}
                            </p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">R$ {{ number_format($product->price,2) }}</p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <button type="button"
                                    onclick="Livewire.emit('openModal', 'admin.products.edit',{{json_encode(['product_id'=>$product->id])}})"
